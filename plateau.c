...
void afficherPlateau(Tuile plateau[12][26],Joueur tabJ[4],int choix){
    ...
    for (int i = 1; i < 13; ++i){
        ...
        for (int j = 0; j < 26; ++j) {
            printf("|");
            Couleur(tabJ[0],plateau[i-1][j].couleur);
    ...
    for (int i = 0; i < 6; ++i) {
        Couleur(tabJ[0],tabJ[0].pupitre[i].couleur);
        printf(" %c",tabJ[0].pupitre[i].symbole);
        Couleur(blanc,i);
    }
    printf("\n");
    for (int i = 0; i < 6; ++i) {
        Couleur(tabJ[1],tabJ[1].pupitre[i].couleur);
        printf(" %c",tabJ[1].pupitre[i].symbole);
        Couleur(blanc,i);
    }
    printf("\n");
    for (int i = 0; i < 6; ++i) {
        Couleur(tabJ[2],tabJ[2].pupitre[i].couleur);
        printf(" %c",tabJ[2].pupitre[i].symbole);
        Couleur(blanc,i);
    }
    printf("\n");
    for (int i = 0; i < 6; ++i) {
        Couleur(tabJ[3],tabJ[3].pupitre[i].couleur);
